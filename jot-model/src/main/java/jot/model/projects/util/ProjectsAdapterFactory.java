...
public class ProjectsAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ProjectsSwitch<Adapter> modelSwitch =
		new ProjectsSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link jot.model.projects.Project <em>Project</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
