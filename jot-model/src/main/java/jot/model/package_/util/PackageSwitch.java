 ...
 * @generated
 */
public class PackageSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PackagePackage.PACKAGE: {
				jot.model.package_.Package package_ = (jot.model.package_.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PackagePackage.INTERCEPTOR: {
				Interceptor interceptor = (Interceptor)theEObject;
				T result = caseInterceptor(interceptor);
				if (result == null) result = caseBaseElement(interceptor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PackagePackage.EXCEPTION_MAPPING: {
				ExceptionMapping exceptionMapping = (ExceptionMapping)theEObject;
				T result = caseExceptionMapping(exceptionMapping);
				if (result == null) result = caseBaseElement(exceptionMapping);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PackagePackage.ACTION: {
			...
			case PackagePackage.SERVICE: {
				Service service = (Service)theEObject;
				T result = caseService(service);
				if (result == null) result = caseBaseElement(service);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PackagePackage.BASE_ELEMENT: {
	 ...
	 * @generated
	 */
	public T casePackage(jot.model.package_.Package object) {
		return null;
	}
