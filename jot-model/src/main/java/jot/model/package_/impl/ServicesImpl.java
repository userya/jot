 ...
 * <ul>
 *   <li>{@link jot.model.package_.impl.ServicesImpl#getService <em>Service</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServicesImpl extends EObjectImpl implements Services {
	...
	protected EClass eStaticClass() {
		return PackagePackage.Literals.SERVICES;
	}
	...
	public EList<Service> getService() {
		if (service == null) {
			service = new EObjectContainmentEList<Service>(Service.class, this, PackagePackage.SERVICES__SERVICE);
		}
		return service;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PackagePackage.SERVICES__SERVICE:
