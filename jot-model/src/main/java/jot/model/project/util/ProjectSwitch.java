...
public class ProjectSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ProjectPackage.PACKAGE: {
				jot.model.project.Package package_ = (jot.model.project.Package)theEObject;
	 ...
	 * @generated
	 */
	public T casePackage(jot.model.project.Package object) {
		return null;
	}
