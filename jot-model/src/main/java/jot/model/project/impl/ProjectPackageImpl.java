...
public class ProjectPackageImpl extends EPackageImpl implements ProjectPackage {
	 ...
	 * @generated
	 */
	public EAttribute getPackage_Resource() {
	...
	public void createPackageContents() {
		...
		createEAttribute(packageEClass, PACKAGE__RESOURCE);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(packageEClass, jot.model.project.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPackage_Name(), ecorePackage.getEString(), "name", null, 0, 1, jot.model.project.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPackage_Resource(), ecorePackage.getEString(), "resource", null, 0, 1, jot.model.project.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
