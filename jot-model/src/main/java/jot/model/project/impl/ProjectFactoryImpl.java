...
public class ProjectFactoryImpl extends EFactoryImpl implements ProjectFactory {
	...
	public static ProjectFactory init() {
		try {
			ProjectFactory theProjectFactory = (ProjectFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.jot.org/project/1.0"); 
	 ...
	 * @generated
	 */
	public jot.model.project.Package createPackage() {
